...
#                      HMBL local amb el repositori remot de GitHub mitjançant 
...
from config import GLOBAL, STEP_05, STEP_30, DATA_ROOT

logging.basicConfig(level=logging.INFO, format="%(asctime)s - [%(levelname)s] - %(message)s")

DESCRIPCIO_FINAL_STEP30 = """
================================================================================
DESCRIPCIÓ DETALLADA DE LA FUNCIONALITAT - STEP 30 (SINCRONITZACIÓ INCREMENTAL)
================================================================================
...
JSON a Internet sense dependre de servidors privats ni costos de manteniment.
...
5. Registre d'Auditoria Persistent: Actualitza el fitxer 'generation_history.log' 
   amb el resultat de la sincronització i el nombre total de nodes publicats.

RESULTAT EXECUTAT CONCRET:
El graf probabilístic SURAR-AINA queda publicat, versionat i accessible via URLs Raw 
públiques. Qualsevol canvi en les probabilitats és immediatament visible per a altres 
agents o usuaris, permetent la inferència distribuïda en temps real.
================================================================================
"""
...
def sincronitzar_graf_probabilistic():
    logging.info("🚀 Iniciant sincronització global del graf HMBL cap a Internet...")
    ...
    for i in range(0, total_fitxers, batch_size):
        ...
        missatge = f"SURAR-AINA-HMBL: Batch upload [{i+1}-{i+len(batch)}] of {total_fitxers} - {timestamp}"
    ...
    if ok_push:
        ...
        logging.info(f"🎉 Èxit de transport: El graf HMBL ({total_fitxers} nodes) ja és públic a Internet!")
    else:
